      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-white to-blue-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="grid lg:grid-cols-2 gap-12 lg:gap-16 w-full p-1"
          >
            {/* Free Course Section */}
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50 hover:shadow-xl transition-shadow">
